    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_edited', models.DateTimeField(help_text='The date and time review was edited', null=True)),
                ('book', models.ForeignKey(help_text='The book the review is for', on_delete=django.db.models.deletion.CASCADE, to='reviews.book')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('AUTHOR', 'Author'), ('CO_AUTHOR', 'Co-Author'), ('EDITOR', 'Editor')], max_length=20, verbose_name='The role contributor had in this book')),
